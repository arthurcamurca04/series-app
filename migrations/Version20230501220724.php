 ...
 */
final class Version20230501220724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE episode (id SERIAL NOT NULL, season_id INT NOT NULL, number SMALLINT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_DDAA1CDA4EC001D1 ON episode (season_id)');
        $this->addSql('CREATE TABLE season (id SERIAL NOT NULL, series_id INT NOT NULL, number SMALLINT NOT NULL, PRIMARY KEY(id))');
